<template>
	<view class="dataTable">
		...
		<view class="dataTable-canvas">
			<view class="titlebox">
				<!-- 文本盒子 -->
				<view class="title">{{$t('components.profitable-market.5qzzfstq5d00')}}</view>
				<!-- 买入卖出盒子 -->
				<view class="smalltitle">
					<view class="icontitle">
						<view class="lefticon"></view>
						<view>{{$t('components.profitable-market.5qzzfstq6ic0')}}</view>
					</view>
					<view class="icontitle">
						<view class="righticon"></view>
						<view>{{$t('components.profitable-market.5qzzfstq6p80')}}</view>
					</view>
				</view>

				<!-- 账户情绪 市场情绪盒子 -->
				<view class="topbox">
					<view class="topbox-left">{{$t('components.profitable-market.5qzzfstq6tk0')}}</view>
					<view class="topbox-right">{{$t('components.profitable-market.5qzzfstq6xs0')}}</view>
				</view>

				<!-- 名称加图表盒子 -->
				<view class="myEchartsbox" v-for="item in dataArr" :key="item.id">
					<view class="topbox1">
						{{item.title}}
					</view>
					<!-- 每个echarts图标 -->
		...
		data() {
			return {
				...
				dataArr: [{
						...
						cell: [{
								id: 11,
								className: 'myEcharts111',
							},
							{
								id: 12,
								className: 'myEcharts112',
							},
						]
					},
					{
						...
						cell: [{
								id: 13,
								className: 'myEcharts113',
							},
							{
								id: 14,
								className: 'myEcharts114',
							},
						]
					},
					{
						...
						cell: [{
								id: 15,
								className: 'myEcharts117',
							},
							{
								id: 16,
								className: 'myEcharts118',
							},
						]
					},
				]
